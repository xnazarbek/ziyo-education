...
export default function LoginPage({ setIsAuthenticated }) {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-slate-950 text-slate-100 font-sans">
      <form onSubmit={handleLogin} className="bg-slate-900 border border-slate-800 p-8 rounded-2xl shadow-2xl w-96 space-y-6">
        <div className="text-center space-y-2">
          <div className="w-12 h-12 bg-indigo-600 rounded-xl mx-auto flex items-center justify-center font-black text-xl text-white">Z</div>
          <h1 className="text-xl font-bold">Ziyo Education</h1>
          <p className="text-xs text-slate-400">O'qituvchi uchun maxsus panel</p>
        </div>
        ...
        <button type="submit" className="w-full bg-indigo-600 hover:bg-indigo-500 py-3 rounded-xl font-bold text-sm transition text-white">
          Kirish
        </button>
      </form>
    </div>
